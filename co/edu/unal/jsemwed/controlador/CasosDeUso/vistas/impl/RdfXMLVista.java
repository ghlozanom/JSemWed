 ...
 *
 */
public class RdfXMLVista implements IVista {

	//TODO Revisar este String
	static String formato = "RDF/XML";	//Representa el tipo de vista
	private IUI ui;
	...
	/* (non-Javadoc)
	 * @see co.edu.unal.jsemwed.controlador.CasosDeUso.vistas.IVista#getModelo()
	 */
