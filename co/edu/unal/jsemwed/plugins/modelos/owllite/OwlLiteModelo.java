 ...
 */
package co.edu.unal.jsemwed.plugins.modelos.owllite;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OwlLiteModelo implements IModelo {
	...
	static String INDIVIDUO = "http://www.w3.org/2002/07/owl#Thing";
	
	String[] nombreElementos = { "Resource","ClaseOWL", "PropiedadOWL", "Individuo" };
	Vector[] elementos = new Vector[nombreElementos.length];
	Vector resources = new Vector();
	Vector clases = new Vector();
	Vector propiedades = new Vector();
	Vector individuos = new Vector();
	String[] busquedas = {"busquedaSencilla"};
    private String modeloSerializado;
	...
	public String ingresarElemento(String modelo2, String uri)
		...
		if( tipoURI.equals(INDIVIDUO) )
		    individuos.add( elemento );
	...
	public Vector[] getElementos() {
		...
		elementos[3] = individuos;
		
		return elementos;
	}

	/* (non-Javadoc)
	 * @see co.edu.unal.jsemwed.comun.IModelo#eliminarElemento(java.lang.String, java.lang.String)
	 */
