 ...
 */
package co.edu.unal.jsemwed.plugins.elementos.propiedadOWL;
 ...
 *
 */
public class PropiedadOWL implements IElemento {
	...
	public PropiedadOWL(){
	    ...
	    operaciones.add("IngresarPropiedadEquivalente");
	    operaciones.add("IngresarInverseOf");
	    operaciones.add("IngresarTransitiveProperty");
	    operaciones.add("IngresarSymmetricProperty");
	    operaciones.add("IngresarFunctionalProperty");
	    operaciones.add("IngresarInverseFunctionalProperty");
