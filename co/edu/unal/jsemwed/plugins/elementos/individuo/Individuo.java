 ...
 */
package co.edu.unal.jsemwed.plugins.elementos.individuo;
 ...
 *
 */
public class Individuo implements IElemento {
	...
	public Individuo(){
	    ...
	    operaciones.add( "IngresarSameAs");
	    operaciones.add("IngresarDifferentFrom");
	    operaciones.add("IngresarAllDifferent");
