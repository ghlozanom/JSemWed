 ...
 *
 */
public class IngresarPropiedadEquivalenteOpUI extends OperacionUI implements
    ...
    public Vector getStatement() {
        ...
        ispDialog = new JDialog( ventanaPrincipal, 
                labels.getString("IngresarPropiedadEquivalente"), true );
        
        JPanel propiedadPanel = new JPanel( new GridLayout(2,1) );
        JPanel labelPanel = new JPanel();
        ((FlowLayout)labelPanel.getLayout()).setAlignment(FlowLayout.CENTER );
        JLabel propiedadLabel = new JLabel( labels.getString("IngresarPropiedadEquivalente"));
