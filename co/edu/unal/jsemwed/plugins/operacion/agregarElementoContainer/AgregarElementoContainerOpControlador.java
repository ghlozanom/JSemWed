 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AgregarElementoContainerOpControlador implements
	...
	public void ejecutar() {
	    ...
	    String[] statement = (String[]) this.statement.get(0);
		modeloHandler.adicionarOperacion( statement[0], "EliminarStatement" );
