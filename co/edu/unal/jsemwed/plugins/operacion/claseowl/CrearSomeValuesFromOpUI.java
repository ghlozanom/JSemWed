 ...
 *
 */
public class CrearSomeValuesFromOpUI extends OperacionUI implements IOperacionUI, ActionListener {
    ...
    public Vector getStatement() {
        ...
        ispDialog = new JDialog( ventanaPrincipal, 
                labels.getString("CrearSomeValuesFrom"), true );
        ...
        JLabel propiedadLabel2 = new JLabel( labels.getString("IngreseClase"));
        labelPanel2.add( propiedadLabel2 );
        Vector propiedadesVector2 = new Vector();
        Iterator it2 = allElements[1].iterator();
        while( it2.hasNext() ){
